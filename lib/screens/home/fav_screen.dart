      ...
      return BlocBuilder<SensorsBloc, SensorsState>(
        ...
        return BlocBuilder<DevicesBloc, DevicesState>(
          builder: (context, devices) {
            ...
            Map<Room, (List<Device>, List<Sensor>)> favRoomsMap = {};
            ...
            for (var sensor in sensorsState.sensors) {
              if (sensor.isFavorite) {
                var room = rooms.rooms
                    .firstWhere((element) => element.id == sensor.roomId);
                if (favRoomsMap.containsKey(room)) {
                  favRoomsMap[room]!.$2.add(sensor);
                } else {
                  favRoomsMap[room] = ([], [sensor]);
                }
              }
            }
            ...
            return favRoomsMap.isEmpty
                ? const Center(
                    child: Padding(
                      ...
                      child: Text(
                          "Brak urządzeń w ulubionych pokojach, dodaj pokój lub urządzenie do ulubionych!",
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return BlocBuilder<Room, RoomCubitState>(
                            ...
                            builder: (context, state) {
                              ...
                              return RoomCard2(
                                room: room,
                                devices: favRoomsMap[room]!.$1,
                                sensors: favRoomsMap[room]!.$2,
                              );
                            },
                          );
                        },
