...
class HomepageScreenExpanded extends StatefulWidget {
  static const routeName = '/homepage';
  const HomepageScreenExpanded({super.key});

  @override
  State<HomepageScreenExpanded> createState() => _HomepageScreenExpandedState();
}

class _HomepageScreenExpandedState extends State<HomepageScreenExpanded> {
  List<Widget> pages = [
    FavScreen(),
    AutomationsScreen(),
  ];
